    ...
    <div className="p-3 sm:p-6">
      ...
      <div className="bg-[#111827] rounded-lg p-3 sm:p-4 border border-gray-800">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={chartData} layout="vertical" margin={{ left: 5, right: 40, top: 5, bottom: 5 }}>
      ...
      {/* Table */}
      <div className="mt-4 sm:mt-6 bg-[#111827] rounded-lg p-3 sm:p-4 border border-gray-800">
