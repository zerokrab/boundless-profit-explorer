...
export default function App() {
  ...
  // Only render sidebar on Calculator page
  const showSidebar = activePage === 'Calculator';
  ...
  return (
    <div className="flex h-screen bg-[#0a0f1e] text-gray-100 overflow-hidden">
      ...
      {/* Sidebar — hidden off-screen on mobile, visible on lg+ — only on Calculator page */}
      {showSidebar && (
        <div className={`
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div className="bg-[#0d1224] border-b border-gray-800 flex-shrink-0">
          <div className="flex items-center h-11 px-3 sm:px-6 gap-3">
            {/* Mobile menu button (Calculator page only) */}
            {showSidebar && (
              <button
            ...
            {/* Page-level navigation — visually distinct from sub-tabs */}
        ...
        {/* ---- Calculator sub-tabs (only on Calculator page) ---- */}
        {activePage === 'Calculator' && (
          <div className="bg-[#111827] border-b border-gray-800 flex-shrink-0">
            {/* Mobile-only: ticker + epoch status row */}
