  ...
  return (
    <div className="flex h-screen bg-[#0a0f1e] text-gray-100 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Header — two rows on mobile, single row on lg+ */}
        <div className="bg-[#111827] border-b border-gray-800 flex-shrink-0">
          {/* Row 1: menu button + ticker + epoch status + GitHub */}
          <div className="flex items-center px-3 sm:px-6 py-2 gap-3 lg:hidden">
            <button
